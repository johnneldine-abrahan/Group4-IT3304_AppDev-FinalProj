      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            GradeCard(subject: 'Mathematics', teacher: 'TORREALBA, HAVEN BRIELLE D.', grade: 75),
            GradeCard(subject: 'Science', teacher: 'LINDO, MAGDALENE LUCY T.', grade: 80),
            GradeCard(subject: 'Araling Panlipunan', teacher: 'BALANGAO, DYLAN KATELYN M.', grade: 83),
            ...
            GradeCard(subject: 'Computer', teacher: 'NAVARRO, LOURDES C.', grade: 87),
          ],
        ),
      ),
    );
